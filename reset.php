...
<body style="margin:0;height: 100%;outline: none;color: #042A38 !important;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/ritik.png);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: auto;padding-bottom: 5vw;">
        <center>
...
if (isset($_POST['submit'])) {
    if (isset($_POST['email1']) && isset($_POST['pass1']) && isset($_POST['cpass1'])) {
        ...
        $password = crypt($password, 'ritikrajchauhan');
        $cpassword = mysqli_real_escape_string($conn, $_POST['cpass1']);
        $cpassword = crypt($cpassword, 'ritikrajchauhan');
        if ($password === $cpassword) {
            ...
            if ($res == true) {
                ...
                if ($dbmail === $username) {
                    ...
                    $mail->Body = '<center><div style="width:100%;background-color:#042A38;color: #fff;height:auto; "><h1>Hello ' . $dbname . '<br></h1><br>here is your security code to reset the password <h1>' . $otp . '</h1><br>  don\'t share security code with any one. <br><br><br>Thank You<br>Online Examination System<br><br><a href="mailto:">Contact Us</a></div></center>';
                    if (!$mail->send()) {
